...
public class CFNode {
     ...
     * @param e2
     */
    protected void redistributeEntries(ArrayList<CFEntry> oldEntries1, ArrayList<CFEntry> oldEntries2, CFEntryPair closeEntries,
        ...
        for (CFEntry e : v) {
            double dist1 = closeEntries.e1.distance(e);
            double dist2 = closeEntries.e2.distance(e);
